...
if (!ADBLOCK && !CI && !DISABLE_OPENCOLLECTIVE && !SILENT) {
  log(
    '\u001B[96mThank you for using kst-web (\u001B[94m https://github.com/SoldierAb/kst-web \u001B[96m)!\u001B[0m\n',
  );
  // log(
  //   '\u001B[96mThe project needs your help! Please consider supporting of kst-web on Open Collective or Patreon: ' +
  //     emoji.get('pray') +
  //     '\u001B[0m',
  // );
  // log('\u001B[96m>\u001B[94m https://opencollective.com/kst-web \u001B[0m');
